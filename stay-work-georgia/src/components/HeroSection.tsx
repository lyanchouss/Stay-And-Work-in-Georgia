...
import ieRegistrationSupportIcon from '../assets/IE_Registration_Support_removebg.png'
...
export default function HeroSection({ services, scrollToId }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden" aria-label="Hero">
      ...
      {/* Smooth bottom fade: photo → page background */}
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-[52px] pt-[60px] sm:px-6 sm:pt-[75px] lg:px-8 lg:pb-[52px]" style={{ zoom: 0.77 }}>
        <div className="text-center">
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: `linear-gradient(to bottom, rgba(255,255,255,${(cs.topOpacity / 100).toFixed(3)}), transparent)`,
                      }}
                    />
                    {/* Bottom edge linear vignette */}
                    <div
                      aria-hidden="true"
                      className="pointer-events-none absolute inset-x-0 bottom-0 z-0 rounded-b-[inherit]"
                      style={{
                        height: '55%',
                        background: `linear-gradient(to top, ${vc(cs.hue, cs.saturation, cs.bottomEdge)}, transparent)`,
                      }}
                    />
                    {/* Top edge linear vignette */}
                    <div
                      aria-hidden="true"
                      className="pointer-events-none absolute inset-x-0 top-0 z-0 rounded-t-[inherit]"
                      style={{
                        height: '55%',
                        background: `linear-gradient(to bottom, ${vc(cs.hue, cs.saturation, cs.topEdge)}, transparent)`,
                      }}
                    />
                    ...
                    <div className="relative z-[1] flex flex-col items-center text-center">
                      {iconSrc && (
                        <img
                          ...
                          style={{
                            height: '152px',
                            filter:
                              'brightness(0) saturate(100%) invert(72%) sepia(38%) saturate(520%) hue-rotate(345deg) brightness(0.93)',
                          }}
                        />
                      )}

                      <h3
                        className="mt-4 relative -top-0.5 text-[21px] font-bold leading-tight lg:text-[22px]"
                      ...
                      <p
                        className="mt-2 px-1 text-[14.5px] leading-[1.65] tracking-[0.01em] lg:text-[15.5px]"
          ...
          <div className="reveal mx-auto mt-16 max-w-3xl" data-reveal style={delayStyle(200)}>
            <h3 className="text-center font-['Montserrat'] text-[37px] font-medium tracking-tight text-[#EADFD0] sm:text-[46px]">
            ...
            <div className="mt-5 flex items-center justify-center gap-3">
              ...
              <div
                ...
                style={{ background: 'rgba(201,149,90,0.75)' }}
              />
              <div className="h-px w-16 rounded-full" style={{ background: 'linear-gradient(to right, rgba(201,149,90,0.25), rgba(201,149,90,0.70), rgba(201,149,90,0.25))' }} />
            ...
            <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
              <a
                ...
                style={{
                  borderColor: 'rgba(201, 149, 90, 0.22)',
              ...
              >
                <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className="h-4.5 w-4.5 text-[#d7b183]">
                  <path
                    d="M3 4.2A1.2 1.2 0 0 1 4.2 3h1.6a1 1 0 0 1 .95.72l.65 2.34a1 1 0 0 1-.43 1.1l-1.2.74a9.4 9.4 0 0 0 4.32 4.32l.74-1.2a1 1 0 0 1 1.1-.43l2.34.65a1 1 0 0 1 .72.95v1.6A1.2 1.2 0 0 1 14.8 17 11.8 11.8 0 0 1 3 5.2z"
                    stroke="currentColor"
                    strokeWidth="1.4"
                    strokeLinecap="round"
              ...
              <a
                ...
                style={{
                  borderColor: 'rgba(80, 200, 120, 0.18)',
              ...
              >
                <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className="h-[18px] w-[18px] text-[#a8d8b4]">
                  <path
                    d="M10 3.2a6.8 6.8 0 0 0-5.93 10.1L3 17l3.86-1.03A6.8 6.8 0 1 0 10 3.2z"
                    stroke="currentColor"
                    strokeWidth="1.4"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M7.7 8.2c.2-.3.4-.3.6-.3.1 0 .2 0 .3.2l.7 1.1c.1.1.1.3 0 .4l-.3.5c.4.8 1 1.3 1.8 1.8l.5-.3c.1-.1.3-.1.4 0l1.1.7c.2.1.2.2.2.3 0 .2 0 .4-.3.6-.3.2-.8.4-1.2.3-1-.2-2-.9-2.9-1.8-.9-.9-1.6-1.9-1.8-2.9-.1-.4.1-.9.3-1.2z"
                    fill="currentColor"
                  />
                </svg>
                WhatsApp
              ...
              >
                <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className="h-[18px] w-[18px] text-[#d7b183]">
                  ...
                  <path
                    d="M3.5 6l5.45 4.37a1.7 1.7 0 0 0 2.1 0L16.5 6"
                    stroke="currentColor"
                    strokeWidth="1.4"
                    strokeLinecap="round"
                    strokeLinejoin="round"
